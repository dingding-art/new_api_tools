...
const themeStyles: Record<ThemeId, {
  ...
  obsidian: {
    ...
    modelName: 'font-semibold text-white break-all',
  ...
  daylight: {
    ...
    modelName: 'font-semibold text-slate-800 break-all',
  ...
  minimal: {
    ...
    modelName: 'font-medium text-gray-800 break-all text-sm',
  ...
  neon: {
    ...
    modelName: 'font-bold text-white break-all tracking-wide',
  ...
  forest: {
    ...
    modelName: 'font-semibold text-emerald-50 break-all',
  ...
  ocean: {
    ...
    modelName: 'font-semibold text-blue-50 break-all',
  ...
  terminal: {
    ...
    modelName: 'font-bold text-green-500 break-all',
  ...
  cupertino: {
    ...
    modelName: 'font-semibold text-gray-900 break-all tracking-tight',
    statsText: 'text-sm text-gray-400',
  ...
  material: {
    ...
    modelName: 'font-medium text-[#1f1f1f] break-all text-lg',
  ...
  openai: {
    ...
    modelName: 'font-medium text-white break-all',
    statsText: 'text-sm text-gray-400',
  ...
  anthropic: {
    ...
    modelName: 'font-serif font-medium text-[#191919] break-all text-xl',
  ...
  vercel: {
    ...
    modelName: 'font-bold text-white break-all tracking-tight group-hover:text-white transition-colors',
  ...
  linear: {
    ...
    modelName: 'font-medium text-[#ededee] break-all',
  ...
  stripe: {
    ...
    modelName: 'font-bold text-[#3c4257] break-all',
  ...
  github: {
    ...
    modelName: 'font-semibold text-[#c9d1d9] break-all hover:text-[#58a6ff] transition-colors',
  ...
  discord: {
    ...
    modelName: 'font-bold text-[#f2f3f5] break-all group-hover:text-white transition-colors',
  ...
  tesla: {
    ...
    modelName: 'font-medium text-white break-all tracking-wider uppercase',
  ...
  lavender: {
    ...
    modelName: 'font-semibold text-[#3d2e5c] break-all',
